...
# Task 1 + 2
python3 main.py train --model cifar_mlp --epochs 30 --batch-size 128 --validation-split 0.1
python3 main.py test --model cifar_mlp

python3 main.py train --model cnn --epochs 30 --batch-size 128 --validation-split 0.1
python3 main.py test --model cnn

# Task 3 (augmentation)
python3 main.py train --model cnn_aug --epochs 30 --batch-size 128 --validation-split 0.1
python3 main.py test --model cnn_aug

# Task 5 (improvement: GAP + early stopping)
python3 main.py train --model cnn_gap --epochs 30 --batch-size 128 --validation-split 0.1
